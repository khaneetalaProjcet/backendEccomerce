...
import { goldInvoice, goldInvoiceInterface } from './wallet/entities/goldBoxInvoice.entity';
...
export class AppService {
  ...
  @InjectModel(goldInvoice.name) private goldBoxInvoice : Model<goldInvoiceInterface>,
